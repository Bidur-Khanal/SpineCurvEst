...
def DenseNet(input_shape=(None,None,1), dense_blocks=3, dense_layers=-1, growth_rate=12, dropout_rate=None,
    ...
    dense1 = Dense(128, activation='linear')(flattenlayer)
    if dropout_rate:
        dense1 = Dropout(dropout_rate)(dense1)
    output1 = Dense(8, activation='linear')(dense1)
